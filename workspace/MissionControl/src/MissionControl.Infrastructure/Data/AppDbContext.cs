...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Agent>().HasData(
            new Agent { Id = 1, Name = "Whis",       Model = "llama3",                              ExecutionBackend = ExecutionBackend.OpenClaw,    ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Whis),       Status = AgentStatus.Idle, Emoji = "🌀", Description = "Orchestrator — routes tasks, manages state machine, handles retries", Skills = "Orchestration,Routing,Escalation",                ProjectId = 1 },
            ...
            new Agent { Id = 3, Name = "Kakarot",    Model = "llama3",                              ExecutionBackend = ExecutionBackend.OpenClaw,    ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Kakarot),    Status = AgentStatus.Idle, Emoji = "🔥", Description = "Standard coder for moderate complexity tasks",                         Skills = "Coding,Implementation,Testing",                  ProjectId = 1 },
            ...
            new Agent { Id = 5, Name = "Piccolo",    Model = "llama3",                              ExecutionBackend = ExecutionBackend.OpenClaw,    ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Piccolo),    Status = AgentStatus.Idle, Emoji = "🌿", Description = "Refactorer — cleans code, applies SOLID principles",                   Skills = "Refactoring,CleanCode,SOLID",                    ProjectId = 1 },
            ...
            new Agent { Id = 7, Name = "Trunks",     Model = "llama3",                              ExecutionBackend = ExecutionBackend.OpenClaw,    ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Trunks),     Status = AgentStatus.Idle, Emoji = "💾", Description = "Memory & learning — stores summaries, refines routing weights",        Skills = "MemoryManagement,Learning,Analytics",            ProjectId = 1 },
            ...
            new Agent { Id = 9, Name = "Cell",       Model = "gpt-4o-mini",                        ExecutionBackend = ExecutionBackend.OpenClaw,    ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Cell),       Status = AgentStatus.Idle, Emoji = "🦗", Description = "Security Auditor — static/dynamic analysis, vulnerability checks",      Skills = "Security,Audit,Analysis",                        ProjectId = 1 },
            new Agent { Id = 10, Name = "Dende",     Model = "gpt-4o-mini",                        ExecutionBackend = ExecutionBackend.OpenClaw,    ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Dende),      Status = AgentStatus.Idle, Emoji = "🧑‍🦲", Description = "Test Engineer — automated/unit/integration/fuzz testing",            Skills = "Testing,QA,Fuzzing",                              ProjectId = 1 },
            new Agent { Id = 11, Name = "Shenron",   Model = "gpt-4o-mini",                        ExecutionBackend = ExecutionBackend.OpenClaw,    ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Shenron),    Status = AgentStatus.Idle, Emoji = "🐉", Description = "Release Manager — deployment, monitoring, rollback",                   Skills = "Release,Deployment,Monitoring",                   ProjectId = 1 },
            new Agent { Id = 12, Name = "Jaco",      Model = "gpt-4o-mini",                        ExecutionBackend = ExecutionBackend.OpenClaw,    ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Jaco),       Status = AgentStatus.Idle, Emoji = "👽", Description = "Compliance/Legal — licensing, privacy, regulatory checks",              Skills = "Compliance,Legal,Privacy",                        ProjectId = 1 },
