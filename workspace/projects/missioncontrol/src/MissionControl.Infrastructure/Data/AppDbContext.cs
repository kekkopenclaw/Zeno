...
public class AppDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Agent>().HasData(
            new Agent { Id = 1, Name = "Whis", Model = "llama3", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Whis), Status = AgentStatus.Idle, Emoji = "🌀", Description = "Orchestrator — routes tasks, manages state machine, handles retries", Skills = "Orchestration,Routing,Escalation", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 2, Name = "Beerus", Model = "qwen2.5-coder:14b-instruct-q4_K_M", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = true, PushRole = false, Role = nameof(AgentRole.Beerus), Status = AgentStatus.Idle, Emoji = "😼", Description = "Architect — high-level system design and decisions", Skills = "Architecture,SystemDesign,Planning", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 3, Name = "Kakarot", Model = "llama3", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Kakarot), Status = AgentStatus.Idle, Emoji = "🔥", Description = "Standard coder for moderate complexity tasks", Skills = "Coding,Implementation,Testing", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 4, Name = "Vegeta", Model = "qwen2.5-coder:14b-instruct-q4_K_M", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = true, PushRole = true, Role = nameof(AgentRole.Vegeta), Status = AgentStatus.Idle, Emoji = "⚡", Description = "Advanced coder — handles high complexity and critical tasks", Skills = "AdvancedCoding,Performance,Security", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 5, Name = "Piccolo", Model = "llama3", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Piccolo), Status = AgentStatus.Idle, Emoji = "🌿", Description = "Refactorer — cleans code, applies SOLID principles", Skills = "Refactoring,CleanCode,SOLID", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 6, Name = "Gohan", Model = "qwen2.5-coder:14b-instruct-q4_K_M", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = true, PushRole = true, Role = nameof(AgentRole.Gohan), Status = AgentStatus.Idle, Emoji = "📖", Description = "Reviewer — inspects output, approves or triggers fix cycle", Skills = "CodeReview,QualityAssurance,Security", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 7, Name = "Trunks", Model = "llama3", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Trunks), Status = AgentStatus.Idle, Emoji = "💾", Description = "Memory & learning — stores summaries, refines routing weights", Skills = "MemoryManagement,Learning,Analytics", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 8, Name = "Bulma", Model = "qwen2.5-coder:14b-instruct-q4_K_M", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = true, PushRole = true, Role = nameof(AgentRole.Bulma), Status = AgentStatus.Idle, Emoji = "🔧", Description = "Tooling — manages context injection and prompt construction", Skills = "Tooling,ContextManagement,PromptEngineering", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 9, Name = "Cell", Model = "gpt-4o-mini", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Cell), Status = AgentStatus.Idle, Emoji = "🦗", Description = "Security Auditor — static/dynamic analysis, vulnerability checks", Skills = "Security,Audit,Analysis", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 10, Name = "Dende", Model = "gpt-4o-mini", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Dende), Status = AgentStatus.Idle, Emoji = "🧑‍🦲", Description = "Test Engineer — automated/unit/integration/fuzz testing", Skills = "Testing,QA,Fuzzing", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 11, Name = "Shenron", Model = "gpt-4o-mini", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Shenron), Status = AgentStatus.Idle, Emoji = "🐉", Description = "Release Manager — deployment, monitoring, rollback", Skills = "Release,Deployment,Monitoring", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 12, Name = "Jaco", Model = "gpt-4o-mini", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Jaco), Status = AgentStatus.Idle, Emoji = "👽", Description = "Compliance/Legal — licensing, privacy, regulatory checks", Skills = "Compliance,Legal,Privacy", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 13, Name = "Zeno", Model = "gpt-4o", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Zeno), Status = AgentStatus.Idle, Emoji = "👑", Description = "Supreme Overseer — self-improvement, process optimization, ultimate authority", Skills = "Oversight,Optimization,Authority", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 14, Name = "Jiren", Model = "gpt-4o", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.Jiren), Status = AgentStatus.Idle, Emoji = "💪", Description = "Enforcer — ultimate strength, handles escalations, last-resort interventions", Skills = "Enforcement,Escalation,Intervention", ProjectId = 1, TeamId = 1 },
            new Agent { Id = 15, Name = "GrandPriest", Model = "gpt-4o", ExecutionBackend = ExecutionBackend.OpenClaw, ToolsEnabled = false, PushRole = false, Role = nameof(AgentRole.GrandPriest), Status = AgentStatus.Idle, Emoji = "🧙‍♂️", Description = "Grand Priest — father of Whis, supreme angel, oversees all angels and orchestrators", Skills = "Oversight,Orchestration,Leadership", ProjectId = 1, TeamId = 1 }
        );
